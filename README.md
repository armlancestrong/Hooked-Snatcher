...
Just a very nice and reliable tool for token grabbing, and so forth. It has alot of nice features that can be toggled on or off using a very simple config string.
